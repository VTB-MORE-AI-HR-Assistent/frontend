...
```
https://hraiassistant.ru/interview/[sessionId]?token=[jwt_token]
```
...
_This implementation plan provides a complete roadmap for integrating Daily.co audio interviews into the VTB AI HR Assistant frontend. The modular approach allows for incremental development and testing._
